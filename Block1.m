...
try
    ...
    for trial = 1:numTrials
        ...
        % Display animated grating for 75 ms
        ...
        Screen('FillRect', window, gray); % Fill the screen with gray (blank)
        Screen('Flip', window); % Flip to show the blank screen
